...
class oriflame extends React.Component
{
    render(){
        return(
            <div>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="product-details-img product-details-tab">
                                ...
                                <div id="gallery" class="product-dec-slider-2">
                                    <a href=" " class="active" data-image="assets/images/cosmatic/m.jpg" data-zoom-image="assets/images/cosmatic/m.jpg">
                                        <img src="assets/images/cosmatic/m.jpg" alt="" />
                                    </a>
                                    <a href=" " data-image="assets/images/cosmatic/n.jfif" data-zoom-image="assets/images/cosmatic/n.jfif">
                                        <img src="assets/images/cosmatic/n.jfif" alt="" />
                                    </a>
                                    <a href=" " data-image="assets/images/cosmatic/o.jpg" data-zoom-image="assets/images/cosmatic/o.jpg">
                                        <img src="assets/images/cosmatic/o.jpg" alt="" />
                                    </a>
                                    <a href=" " data-image="assets/images/cosmatic/p.jpg" data-zoom-image="assets/images/cosmatic/p.jpg">
                                        <img src="assets/images/cosmatic/p.jpg" alt="" />
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="product-details-content">
                                <h2>Oriflame sweden lip gloss</h2>
                                ...
                                <div class="pro-details-rating-wrap">
                                   ...
                                   <span class="read-review"><a href=" " class="reviews">Read reviews (1)</a></span>
                                </div>
                                ...
                                <p><b>DESCRIPTION:</b></p>
                                <p>Lip balm strawberry love nature with smoothing and regenerating effect and soft coral shade. The formula of balm contains a natural extract of strawberries. Strawberry juicy lip balm.
Lip balm raspberry love natureotlichno nourishes and softens the delicate skin of the lips, giving a juicy berry pleasant aroma with a slight pink tinge. The formula with natural extracts of raspberries. Raspberry juicy lip balm.
Lip balm cherry love nature of the formula, which is enriched with natural extract of cherries, perfectly protects and moisturizes the skin of the lips with a translucent red color and a pleasant berry flavor. Cherry balm juicy lips.
                ...
                <div class="container">
                    ...
                    <div class="recent-product-slider owl-carousel owl-nav-style">
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="assets/images/cosmatic/4.jfif" alt="" />
                                    <img class="second-img" src="assets/images/cosmatic/4.jfif" alt="" />
                                </a>
                            ...
                            <div class="product-decs">
                                ...
                                <h2><a href="single-product.html" class="product-link">Meralite facial Cream</a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                        ...
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="assets/images/cosmatic/5.jfif" alt="" />
                                    <img class="second-img" src="assets/images/cosmatic/5.jpfif" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href=" " data-link-action="quickview" title="Quick view" data-toggle="modal" data-target="#exampleModal">
                                        <i class="ion-ios-search-strong"></i>
                            ...
                            <div class="product-decs">
                                <a class="inner-link" href="shop-4-column.html"><span>STUDIO DESIGN</span></a>
                                <h2><a href="single-product.html" class="product-link">Himalaya Nourishing white Cream</a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                        ...
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="assets/images/cosmatic/6.jfif" alt="" />
                                    <img class="second-img" src="assets/images/cosmatic/6.jfif" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href=" " data-link-action="quickview" title="Quick view" data-toggle="modal" data-target="#exampleModal">
                                        <i class="ion-ios-search-strong"></i>
                            ...
                            <div class="product-decs">
                                ...
                                <h2><a href="single-product.html" class="product-link">Aroma magic anti oxi cream</a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                        ...
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="assets/images/cosmatic/lotus herbal.jfif" alt="" />
                                    <img class="second-img" src="assets/images/cosmatic/lotus herbal.jfif" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href=" " data-link-action="quickview" title="Quick view" data-toggle="modal" data-target="#exampleModal">
                                        <i class="ion-ios-search-strong"></i>
                            ...
                            <div class="product-decs">
                                <a class="inner-link" href="shop-4-column.html"><span>GRAPHIC CORNER</span></a>
                                <h2><a href="single-product.html" class="product-link">Lotus herbal Cream.</a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                        ...
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="assets/images/cosmatic/7.jfif" alt="" />
                                    <img class="second-img" src="assets/images/cosmatic/7.jfif" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href=" " data-link-action="quickview" title="Quick view" data-toggle="modal" data-target="#exampleModal">
                                        <i class="ion-ios-search-strong"></i>
                            ...
                            <div class="product-decs">
                                <a class="inner-link" href="shop-4-column.html"><span>GRAPHIC CORNER</span></a>
                                <h2><a href="single-product.html" class="product-link">Mamaearth face Cream</a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                        ...
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="assets/images/cosmatic/9.jfif" alt="" />
                                    <img class="second-img" src="assets/images/cosmatic/9.jfif" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href=" " data-link-action="quickview" title="Quick view" data-toggle="modal" data-target="#exampleModal">
                                        <i class="ion-ios-search-strong"></i>
                            ...
                            <div class="product-decs">
                                <a class="inner-link" href="shop-4-column.html"><span>STUDIO DESIGN</span></a>
                                <h2><a href="single-product.html" class="product-link">Lotus botanical face serum.</a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
